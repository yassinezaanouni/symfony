...
return [
    ...
    [ // $dynamicRoutes
        ...
        111 => [[['_route' => 'choose_ticket', '_controller' => 'App\\Controller\\TicketController::chooseTicket'], ['id'], ['POST' => 0, 'GET' => 1], null, false, false, null]],
        123 => [[['_route' => 'app_ticket_edit', '_controller' => 'App\\Controller\\TicketController::edit'], ['id'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        132 => [
